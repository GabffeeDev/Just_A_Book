...
label .day_4:
    ...
    "La página."
    "Aquella que escribí hace mucho tiempo."
    "La que nunca debió permanecer dentro del libro."
    "Al día siguiente llegué al club antes que todos."
    "Mi mirada recorrió el salón de un extremo a otro."
    "Él todavía no había llegado."
    "Apreté con fuerza el borde de mi manga."
    "{i}Tengo que recuperar el libro antes de que la lea.{/i}"
    ...
    "Mi antigua anotación decía:"
    "'Hay personas que prefieren ser heridas antes que ser abandonadas.'"
    "Debajo de ella, [player] había escrito:"
    "'No creo que eso las haga débiles.'"
    "'Creo que significa que llevan mucho tiempo sintiéndose solas.'"
    "Seguí leyendo."
    "'Si alguien escribe algo así..."
    "me gustaría preguntarle cómo llegó a pensar de esa manera.'"
    "'No para juzgarla.'"
    "'Sino porque imagino que debió doler mucho.'"
    "Las letras comenzaron a volverse borrosas."
    "No había una respuesta ingeniosa."
    "Ni una discusión."
    "Ni un intento de convencerme."
    "Solo..."
    "comprensión."
    ...
    y "S-sí..."
    y "Yo solo..."
    "Quise decir que era una simple nota."
    "Que no significaba nada."
    "Que pertenecía a la protagonista."
    "Pero ninguna de esas mentiras salió de mi boca."
    "Le devolví el libro con cuidado."
    "Mis manos temblaban ligeramente."
    y "G-gracias..."
    mc "¿Dije algo malo?"
    y "N-no."
    y "Todo lo contrario."
    "Él me observó con preocupación, pero no insistió."
    "Guardó el libro en su mochila y se alejó para hablar con los demás."
    "Yo permanecí inmóvil."
    "Mirando mis propias manos."
    "Siempre había creído que mi mayor miedo era que alguien leyera esas palabras."
    "Que descubriera lo que escondían."
    "Pero estaba equivocada."
    "Lo que realmente me asustaba..."
    "era que alguien pudiera entenderlas."
    "Porque si alguien las comprendía..."
    "entonces ya no podía seguir fingiendo que solo eran anotaciones sobre una novela."
    jump .day_5

label .day_5:
    "Esa noche abrí el libro varias veces."
    ...
    "siempre podía decir que hablaba de la protagonista."
    "Que solo era un análisis."
    "Pero ahora..."
    "esas palabras ya no me protegían."
    "Porque alguien había leído entre líneas."
    "Y, aun así..."
    "había permanecido."
    "Tomé el bolígrafo."
    ...
    "Por primera vez..."
    "no quería escribir sobre la novela."
    "Comencé lentamente."
    ...
    "'Pero casi ninguna se atreve a escribirlo.'"
    "'No creo que ocupes demasiado espacio.'"
    "'De hecho...'"
    "'Hay días en los que el club se siente más silencioso cuando no hablas.'"
    "Mis ojos permanecieron fijos sobre esas líneas."
    "Él había escrito algo más."
    "'También quiero decirte algo.'"
    "'Yo tampoco soy tan valiente como parezco.'"
    "'Muchas veces hago bromas o hablo con naturalidad porque me da miedo que los demás piensen que soy un problema.'"
    "'Así que...'"
    "'Supongo que ambos somos mejores escribiendo que diciendo ciertas cosas.'"
    ...
    "alguien había respondido a mis palabras con las suyas."
    "No con consejos."
...
label .day_6:
    ...
    "Durante el trayecto al club no pude evitar pensar en todo lo que había cambiado."
    "Al principio temía que [player] leyera mis anotaciones."
    "Después temía que las comprendiera."
    "Y ahora..."
    "temía que el libro llegara a su final."
    ...
    "La última frase del libro ocupaba apenas una línea."
    ...
    "Comprendí algo muy simple."
    "No necesitaba esconderme detrás de la protagonista."
    ...
    "'Quiero aprender a escribir mi propia historia.'"
    "Cerré lentamente el bolígrafo."
    mc "¿Puedo responder?"
    "Asentí."
    "Él escribió debajo de mis palabras."
    "'Entonces escribe la siguiente página.'"
    ...
    "No por tristeza."
    "Sino por el extraño alivio de no tener que ocultar cada parte de mí."
    "Cerré el libro con cuidado."
    "Esta vez no para esconder las páginas."
    "Sino porque la conversación ya no pertenecía al papel."
    y "¿Sabes...?"
    mc "¿Sí?"
    y "Creo que me gustaría leer otro libro contigo."
    "Él sonrió."
    mc "A mí también."
    ...
    y "Miedo de que..."
    "Mi voz se quebró antes de terminar la frase."
    "Él permaneció en silencio."
    "No intentó completar mis palabras."
    "No intentó corregirme."
    "Simplemente me escuchó."
    mc "Lo sé."
    "Esas dos palabras hicieron más por mí que cualquier explicación."
    "Sentí que los ojos comenzaban a humedecerse."
    "Durante tanto tiempo había intentado parecer tranquila."
    "Reservada."
    "Controlada."
    "Pero frente a él ya no podía sostener esa máscara."
    ...
    y "Porque si alguien me comprendía..."
    y "ya no tendría dónde ocultarme."
    mc "Yuri..."
    "Levanté lentamente la cabeza."
    "Él estaba muy cerca."
    "Lo suficiente para que pudiera ver el cansancio en sus ojos."
    "Y también la ternura con la que me miraba."
    "No era compasión."
    "Era algo mucho más difícil de aceptar."
    "Aceptación."
    ...
    "El gesto fue tan delicado que por un instante olvidé cómo respirar."
    "No retrocedí."
    "Tampoco él."
    "Solo esperó."
    "Como si quisiera darme la oportunidad de apartarme."
    "Pero no lo hice."
    ...
    "Mi corazón latía con tanta fuerza que pensé que podría escucharlo."
    "Cerré los ojos."
    "Y entonces..."
    ...
    "Cuando el beso terminó, permanecimos muy cerca el uno del otro."
